			...
			if(scannedFiles.length) {
				...
				scannedFiles.forEach(function(f) {
					...
					if (fileType == "jpg") {
						...
						var file = $('<li class="files"><a data-fancybox="video" data-type="iframe" data-src="'+ f.path+'" data-caption="' + name + '" title="'+ f.path +'" class="files" style>'+icon+'<span class="name">'+ name +'</span> <span class="details">'+fileSize+'</span></a></li>');						
